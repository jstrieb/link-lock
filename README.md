...
correct, Link Lock decrypts the original URL and redirects there. Otherwise, an
error is displayed. If a hint is added, it is displayed right above the
password prompt.
...
- Simple CAPTCHAs – particularly effective against basic web scrapers that do
